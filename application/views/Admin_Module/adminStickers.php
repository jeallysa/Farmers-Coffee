                                                ...
                                                <td>
                                                 ...
                                                 <td>
                                                    <div class="onoffswitch">
                                                        ...
                                                        <button class="btn btn-danger" data-toggle="modal" data-target="#deactivate<?php echo $row->sticker_id;?>">Deactivate</button>
                                                    ...
                                                    <?php else: ?>
                                                        <!-- Button to Activate -->
                                                        <button class="btn btn-success" data-toggle="modal" data-target="#deactivate<?php echo $row->sticker_id;?>">Activate</button>
